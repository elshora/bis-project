      ...
      <RootLayout>
        <div className="container mx-auto px-4 py-8 text-center">
          ...
          <p className="mb-4">
            ...
            the best shopping experience possible, from the moment they visit
            our website to the moment they receive their order.
          </p>
          <p className="mb-4">
            We are committed to providing our customers with the highest level
            of customer service. Our team of experts is always available to
            answer any questions you may have and to help you find the perfect
            product for your needs. We also offer fast and reliable shipping, so
            you can get your order as quickly as possible.
          </p>
          <p className="mb-4">
